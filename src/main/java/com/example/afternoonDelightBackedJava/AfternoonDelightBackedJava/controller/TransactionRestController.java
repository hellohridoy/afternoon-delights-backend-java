...
public class TransactionRestController {
    ...
    @PostMapping("/api/transactions/transactions-infos")
    ...
    @GetMapping("/api/transactions/transactions-infos/{id}")
    public ResponseEntity<TransactionResponseDTO> getTransactionById(@PathVariable Long id) {
        return ResponseEntity.ok(transactionService.getTransactionById(id));
    }

    @GetMapping("/api/transactions/transactions-infos/employee/{employeeId}")
    ...
    @GetMapping("/api/transactions/transactions-infos/date-range")
    ...
    @PutMapping("/api/transactions/transactions-infos/{id}")
    ...
    @DeleteMapping("/api/transactions/transactions-infos/{id}")
